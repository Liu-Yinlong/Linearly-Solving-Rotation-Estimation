...
def test_ransac_2k(num=200):
    ...
    for ii in range(len(num_model)):
        for jj in range(repeat_time):
                ...
                T1=time.perf_counter_ns()
                R_opt_list,t_opt_list=sequential_ransac(x,y,k_num=num_model[ii],iter_num=2000,th=0.01)
                T2=time.perf_counter_ns()
    ...
    np.savetxt(f'./results/tim-{num}_ransac_2k.txt',tim)
    np.savetxt(f'./results/r_err-{num}_ransac_2k.txt',ave_err_r)
    np.savetxt(f'./results/t_err-{num}_ransac_2k.txt',ave_err_t)
    ...
    plt.tight_layout()
    plt.savefig(f'multi-model-{num}_2k.pdf')
    
    #=======================================================================================================
def test_ransac_5k(num=200):  
    repeat_time=100
    num_model=np.arange(8)+2
...
def test_ransac_multi_10k(num=200):
    repeat_time=100
    num_model=np.arange(8)+2
    ...
    for ii in range(len(num_model)):
        for jj in range(repeat_time):
                ...
                T1=time.perf_counter_ns()
                R_opt_list,t_opt_list=multi_ransac(x,y,k_num=num_model[ii],iter_num=10000,th=0.01)
                T2=time.perf_counter_ns()
    ...
    np.savetxt(f'./results/tim-{num}_multi_ransac_10k.txt',tim)
    np.savetxt(f'./results/r_err-{num}_multi_ransac_10k.txt',ave_err_r)
    np.savetxt(f'./results/t_err-{num}_multi_ransac_10k.txt',ave_err_t)
    ...
    plt.tight_layout()
    plt.savefig(f'multi-model-{num}_multi_10k.pdf')
def test_ransac_multi_2k(num=200):
    repeat_time=100
    num_model=np.arange(8)+2
    ...
    for ii in range(len(num_model)):
        for jj in range(repeat_time):
                ...
                T1=time.perf_counter_ns()
                R_opt_list,t_opt_list=multi_ransac(x,y,k_num=num_model[ii],iter_num=2000,th=0.01)
                T2=time.perf_counter_ns()
    ...
    np.savetxt(f'./results/tim-{num}_multi_ransac_2k.txt',tim)
    np.savetxt(f'./results/r_err-{num}_multi_ransac_2k.txt',ave_err_r)
    np.savetxt(f'./results/t_err-{num}_multi_ransac_2k.txt',ave_err_t)
    ...
    plt.tight_layout()
    plt.savefig(f'multi-model-{num}_multi_2k.pdf')
def test_ransac_multi_5k(num=200):
    repeat_time=100
    num_model=np.arange(8)+2
    ...
    for ii in range(len(num_model)):
        for jj in range(repeat_time):
                ...
                T1=time.perf_counter_ns()
                R_opt_list,t_opt_list=multi_ransac(x,y,k_num=num_model[ii],iter_num=5000,th=0.01)
                T2=time.perf_counter_ns()
    ...
    np.savetxt(f'./results/tim-{num}_multi_ransac_5k.txt',tim)
    np.savetxt(f'./results/r_err-{num}_multi_ransac_5k.txt',ave_err_r)
    np.savetxt(f'./results/t_err-{num}_multi_ransac_5k.txt',ave_err_t)
    ...
    plt.tight_layout()
    plt.savefig(f'multi-model-{num}_multi_5k.pdf')
if __name__=='__main__':
    ...
    # test_ransac_2k(200)
    test_ransac_5k(200)
    test_ransac_multi_10k(200)
    # test_ransac_multi_2k(200)
    test_ransac_multi_5k(200)
